...
export default function App() {
  ...
  useEffect(() => {
  // Bridge IPC to CustomEvent
  const unsubscribe = window.electronAPI.on('toggle-debug', () => {
  ...
  return (
    <>
      <div className={gameState.endgameSequence ? 'lockScreen' : 'hide'}></div>

      <div className={gameState.bluescreen ? 'bluescreen' : 'hide'}>
